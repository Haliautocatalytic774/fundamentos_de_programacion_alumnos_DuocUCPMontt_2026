...
- If you want to try a ready-to-run program, download the `.exe` file.
- If you want to explore all files and source code, download the `.zip` archive.

Click the file name to start downloading. Save it to a location you can easily find, like the Desktop or Downloads folder.

---

## 📂 Step 3: Extract or Run the Files
...
## ⚙️ Step 4: Install or Run the Software
...
- Close the program by clicking the X button or typing `exit` if the program supports it.
...
- If the program crashes or closes immediately, try running it from the Command Prompt:
  ...
  2. Use `cd` to change to the folder where your program is.
  3. Run the program by typing its name, for example: `program.exe`.
